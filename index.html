    ...
    <div class="app">
      <header class="header">
        <div class="grid wide">
              ...
              >
                ...
                <div class="header__qr">
                  ...
                  <div class="header__qr-apps">
                    ...
                    <a href="" class="header__qr-link">
                      <img
                        src="./assets/img/QR/app_store.png"
                        alt="App Store"
                        class="header__qr-download-img"
                      />
                    </a>
                ...
                <a href="" class="header__navbar-item-link">
                  ...
                  <div class="header__notify">
                    ...
                    <ul class="header__notify-list">
                      <li
                        class="header__notify-item header__notify-item--viewed"
                      >
                        <a href="" class="header__notify-link">
                          <span>
                            <img
                              src="./assets/img/store/store_1.png"
                              alt=""
                      ...
                      >
                        <a href="" class="header__notify-link">
                          ...
                          <div class="header__notify-info">
                            <span class="header__notify-name"
                              >Mỹ phẩm Ohui chính hãng giúp giảm lão hóa giảm
                              giá săn sale 50%,
                            </span>
                            <span class="header__notify-description"
                              >Mô tả mỹ phẩm Ohui chính hãng</span
          ...
          <div class="header-with-search">
            <label for="header__sidebar" class="header__sidebar-label">
              <i class="fas fa-bars"></i
            ></label>
            <input
              class="header__mobile-input"
              hidden
              type="checkbox"
              id="header__sidebar"
            />
            ...
            ></label>
            <div class="header__mobile-sidebar hide-on-tablet">
              <ul class="header__mobile-list">
                <li class="header__mobile-sidebar-item">Đăng nhập</li>
                <li class="header__mobile-sidebar-item">Đăng ký</li>
                <li class="header__mobile-sidebar-item">Liên Hệ</li>
                <li class="header__mobile-sidebar-item">Dịch vụ</li>
              </ul>
            </div>
            ...
            <div class="header__search hide-on-mobile">
              <div class="header__search-input-wrap">
                ...
                <div class="header__search-history">
                  ...
                  <ul class="header__seacrh-history-list">
                    <li class="header__seacrh-history-item">
            ...
            <div class="header__cart">
              <div class="header__cart-wrap">
                ...
                <div class="header__cart-list">
                  <img
                    src="./assets/img/cart/no_cart.png"
                    alt=""
                ...
                <ul class="mobile-category__list">
                  <li class="mobile-category__item">
                    <a href="" class="mobile-category__link"
                      >Dụng cụ và thiết bị tiện ích</a
                    >
                  </li>
                  <li class="mobile-category__item">
                    <a href="" class="mobile-category__link"
                  ...
                  <div class="col l-2-4 m-4 c-6">
                    <a class="home-product-item" href="#">
                      <div
                        ...
                        style="
                          background-image: url(./assets/img/store/store_4.jpg);
                        "
                      ></div>
                      <h4 class="home-product-item__name">
                        Mã tấu chém mẻ người chứ không mẻ dao
                      </h4>
      ...
      <footer class="footer">
        ...
        <div class="footer__bottom">
          <div class="grid wide">
            <p class="footer__text">© 2021 - Copyright Lazada:))</p>
          </div>
        </div>
      </footer>
    </div>
